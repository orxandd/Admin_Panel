...
<table class="table no-more-tables table-bordered">
    ...
    <th style="width:8%; vertical-align: middle" class="text-center">
        ...
        <button data-url="<?php echo base_url("secure_admin_panel_gallery_delete_group")?>"
                data-url2="<?php echo base_url("secure_admin_panel_gallery_delete_all")?>"
    ...
    <?php foreach ($gallery as $item) {?>
        <tr class="change_color">
            ...
            <td class="v-align-middle c_vertical_align_middle text-center">
                <img width="120px" height="100px" src="<?php echo base_url("uploads/gallery/$item[name]")?>" alt="Şəkil Yüklənmədi">
            </td>
            ...
            <td class="v-align-middle c_vertical_align_middle text-center">
                <button data-url="<?php echo base_url("secure_admin_panel_gallery_delete/$item[id]")?>" class="btn btn-danger c_delete_portfolio_category">
                    <i class="fa fa-trash"></i>
                    Sil
                </button>
            </td>
