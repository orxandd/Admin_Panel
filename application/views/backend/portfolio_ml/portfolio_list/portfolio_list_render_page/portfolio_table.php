...
<a href="<?php echo base_url("secure_admin_panel_portfolio_add_ml")?>" class="btn btn-success c_right">
...
<?php if (!empty($portfolio)){?>
    ...
    <!--        bunu tapana qeder oldum :D-->
            ...
            <tr>
                ...
                <td class="v-align-middle c_vertical_align_middle text-center">
                    <a href="<?php echo base_url("secure_admin_panel_portfolio_gallery_ml/$item[id]")?>" class="btn btn-primary">
                        <i class="fa fa-image"></i>
                        Qalereya
                    </a>
                </td>
                <td class="v-align-middle c_vertical_align_middle text-center">
                    <a href="<?php echo base_url("secure_admin_panel_portfolio_update_ml/$item[id]")?>" class="btn btn-warning">
                        <i class="fa fa-pencil-square-o"></i>
                        Yenilə
                    </a>
                    <button data-url="<?php echo base_url("secure_admin_panel_portfolio_delete_ml/$item[id]")?>" class="btn btn-danger c_delete_portfolio_category">
