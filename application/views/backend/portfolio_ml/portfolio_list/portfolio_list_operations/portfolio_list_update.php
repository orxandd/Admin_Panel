                ...
                <div class="row" style="margin-top: 50px">
                    <div class="grid-body no-border c_grid_padding">
                        <div class="row">
                            ...
                            <form action="<?php echo base_url("secure_admin_panel_portfolio_update_act_ml/$portfolio[id]")?>" method="post">
                                ...
                                <div class="tab-content">
                                    ...
                                    <div id="az" class="tab-pane fade in active">
                                        ...
                                        <select name="category_az" class="form-control">
                                            <option><?php echo $portfolio["category_name_az"];?></option>
                                            <?php foreach ($categories as $item) {?>

                                                <?php if ($portfolio["category_name_az"] != $item["name_az"]){?>

                                                    <option><?php echo $item["name_az"]?></option>
                                        ...
                                        <textarea id="editor1" name="desc_az"><?php echo $portfolio["desc_az"]?> </textarea>
                                        <br><br>
                                    </div>
                                    <!--                                        Azerbaycanca olan hisse-->
                                    ...
                                    <div id="en" class="tab-pane fade">
                                        ...
                                        <select name="category_en" class="form-control">
                                            <option><?php echo $portfolio["category_name_en"];?></option>
                                            <?php foreach ($categories as $item) {?>

                                                <?php if ($portfolio["category_name_en"] != $item["name_en"]){?>

                                                    <option><?php echo $item["name_en"]?></option>
                                        ...
                                        <textarea id="editor2" name="desc_en"><?php echo $portfolio["desc_en"]?></textarea>
                                        <br><br>
                                    </div>
                                    <!--                                        Ingilisce olan hisse-->
                                    ...
                                    <div id="ru" class="tab-pane fade">
                                        ...
                                        <label>Категория Портфолио</label>
                                        <select name="category_ru" class="form-control">
                                            <option><?php echo $portfolio["category_name_ru"];?></option>
                                            <?php foreach ($categories as $item) {?>

                                                <?php if ($portfolio["category_name_ru"] != $item["name_ru"]){?>

                                                    <option><?php echo $item["name_ru"]?></option>
                                        ...
                                        <textarea id="editor3" name="desc_ru"><?php echo $portfolio["desc_ru"]?></textarea>
                                        <br><br>
                                    </div>
                                    <!--                                        Rusca olan hisse-->
