...
<table class="table no-more-tables table-bordered">
    ...
    <th style="width:8%; vertical-align: middle" class="text-center">
        ...
        <button data-url="<?php echo base_url("secure_admin_panel_portfolio_gallery_delete_group_woc_ml/$portfolio[id]")?>"
                data-url2="<?php echo base_url("secure_admin_panel_portfolio_gallery_delete_all_woc_ml/$portfolio[id]")?>"
        ...
        <tr class="change_color">
            ...
            <td class="v-align-middle c_vertical_align_middle text-center">
                ...
                <input type="checkbox"
                       ...
                       data-switchery
                        data-url="<?php echo base_url("secure_admin_panel_portfolio_gallery_primary_woc_ml/$portfolio[id]/$item[id]")?>"
            ...
            <td class="v-align-middle c_vertical_align_middle text-center">
                <button data-url="<?php echo base_url("secure_admin_panel_portfolio_gallery_delete_woc_ml/$portfolio[id]/$item[id]")?>" class="btn btn-danger c_delete_portfolio_category">
                    <i class="fa fa-trash"></i>
                    Sil
                </button>
            </td>
