...
<?php $this->load->view("backend/includes_for_whole/menu");?>
    ...
    <div class="page-content">
        ...
        <div class="content">
            <h1 class="c_title"><span style="text-decoration: underline"><?php echo $portfolio["name_az"]?></span> Portfoliosunun Qalereyası</h1>
            <div class="grid simple ">
                <div class="row" style="margin-top: 50px">


                    <form action   =   "<?php echo base_url("secure_admin_panel_portfolio_gallery_add_woc_ml/$portfolio[id]")?>"
                          data-url =   "<?php echo base_url("secure_admin_panel_portfolio_gallery_refresh_woc_ml/$portfolio[id]")?>"
