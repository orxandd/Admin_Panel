...
<?php $this->load->view("$this->parent_folder/$this->includes_for_whole/menu");?>
    ...
    <div class="page-content">
        ...
        <div class="content">
            <h1 class="c_title"><?php echo $class["name_az"]?> Klasının Yenilənməsi</h1>
            <div class="grid simple ">
                <div class="row" style="margin-top: 50px">
                    <div class="grid-body no-border c_grid_padding">
                        <div class="row">

                            <form action="<?php echo base_url("secure_admin_panel_car_class_update_act/$class[brand_id]/$class[id]")?>" method="post" enctype="multipart/form-data">
                                ...
                                <div class="tab-content">
                                    ...
                                    <div id="az" class="tab-pane fade in active">
                                        ...
                                        <input id="name" type="text" class="form-control" name="category_name_az" value="<?php echo $class["name_az"]?>">
                                        <br>
                                    </div>
                                    <!--                                        Azerbaycanca olan hisse-->
                                    ...
                                    <div id="en" class="tab-pane fade">
                                        ...
                                        <input id="name" type="text" class="form-control" name="category_name_en" value="<?php echo $class["name_en"]?>">
                                        <br>
                                    </div>
                                    <!--                                        Ingilisce olan hisse-->
                                    ...
                                    <div id="ru" class="tab-pane fade">
                                        ...
                                        <input id="name" type="text" class="form-control" name="category_name_ru" value="<?php echo $class["name_ru"]?>">
                                        <br>
                                    </div>
                                    <!--                                        Rusca olan hisse-->
                                ...
                                <center>
                                    <img style="margin-left: 18px; object-fit: contain;" width="600px" height="300px" src="<?php echo base_url("uploads/car_classes/$class[img]")?>" alt="Şəkil Yüklənmədi">
                                </center>
                                <br><br>
