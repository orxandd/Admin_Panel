...
<div class="page-content">
    ...
    <div class="content">
        <h1 class="c_title">Brendin Əlavə Edilməsi</h1>
        <div class="grid simple ">
            <div class="row" style="margin-top: 50px">
                <div class="grid-body no-border c_grid_padding">
                    <div class="row">

                        <form action="<?php echo base_url("secure_admin_panel_car_brand_add_act")?>" method="post" enctype="multipart/form-data">
                            ...
                            <!--                                3 dilde olan divler-->
                            <div style="margin-bottom: 0!important;" class="tab-content">
